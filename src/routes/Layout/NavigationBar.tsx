  ...
  return (
    <div className="flex justify-between bg-base-100">
      <div className="flex p-2 navBar">
        ...
        {loggedUser && (<Link to="/freeBoard" className="ml-4 btn btn-link">FreeBoard</Link>)}
        {loggedUser && (<Link to="/funBoard" className="ml-4 btn btn-link">FunBoard</Link>)}
        {loggedUser && (<Link to="/jobBoard" className="ml-4 btn btn-link">JobBoard</Link>)}
      </div>
